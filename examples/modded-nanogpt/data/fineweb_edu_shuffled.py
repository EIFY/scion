...
parser = argparse.ArgumentParser(description="FineWeb-Edu shuffled preprocessing")
parser.add_argument("-v", "--version", type=str, default="fineweb_edu", help="Which version to use: fineweb_edu or fineweb")
...
def main():
    ...
    if args.test:
        ...
        assert args.version in ["fineweb_edu", "fineweb"], "version must be either fineweb_edu or fineweb"
        local_dir = remote_name = f"{args.version}_100BT-shuffled"
        ...
        fw = load_dataset("HuggingFaceFW/" + remote_name, split="train")
    # init the tokenizer
